...
// Еще не доделал! Как записать массив Фибоначчи?
...
//        System.arraycopy(digits, 5, cash, 0, 5);
//        for (int j = 0; j < cash.length; j++) {
//            System.out.println(cash[j] + " ");

//        System.arraycopy(fib, 5, cash, 0, 5);
...
//        }
    ...
    public static void findFib(int[] fib) {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void printMenu() {
        System.out.println(" ");
        System.out.println("1 - Вычислить число Фибоначчи");
        System.out.println("2 - Произвести новый расчет");
        System.out.println("3 - Посмотреть прошлые вычисления");
...
public class Praktikum {
    public static void main(String[] args) {
        ...
        Scanner scanner = new Scanner(System.in);
        Converter conv = new Converter(); // Создайте объект класса Converter
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                conv.convert(moneyBeforeSalary, currency); // Вызовите метод класса Converter
            } else if (command == 2) {
