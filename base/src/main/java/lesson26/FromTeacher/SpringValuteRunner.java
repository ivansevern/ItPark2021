...
@Configuration
@ComponentScan("lesson26.FromTeacher")
public class SpringValuteRunner {  //код с помощью рабора ДЗ
    ...
    public static void main(String[] args) {
        ...
        while (scanner.hasNext()) {
            ...
            if (StringUtils.isBlank(text)) {
                System.out.println("Введите не пустое значение кода валюты");
                continue;
            }
            va.getValuteByCode(text.toUpperCase()).ifPresentOrElse(
                    value -> {
                        System.out.printf("Текущий курс валюты %s равен %.4f рублей\n", text, value); //считаю не коректным т.к. ед.валют бывают не равно 1
//как можно добавить остальные параметры, такие как единица валюты, название
                        System.out.println("При необходимости введите новый код валюты или завершите программу");
                    },
